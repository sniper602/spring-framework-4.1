...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	/**
	 * 关键方法
	 * 1.创建beanFactory容器,解析xml的bean配置,beanDefinition注册到BeanFactory中
	 * 2.实例化非延迟加载的单例bean,注册单例bean到DefaultSingletonBeanRegistry中
	 */
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				//spring的hook钩子,调用BeanFactoryPostProcessors
				...
				//2.createBean,实例化非延迟加载的单例bean,注册单例bean到DefaultSingletonBeanRegistry中
				//lazy-init默认值为false,即bean在容器初始化时就会加载
